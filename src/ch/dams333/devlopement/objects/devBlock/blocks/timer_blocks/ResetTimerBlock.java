...
public class ResetTimerBlock extends DevBlock{

    private UUID timerUUID;

    public ResetTimerBlock(Devlopement main, Location loc) {
        super(main, loc);
        super.setType(BlockType.RESET_TIMER);
        timerUUID = null;
    }

    public ResetTimerBlock(File file, Devlopement main) {
        super(file, main);
        super.setType(BlockType.RESET_TIMER);
    ...
    public BlockType getBlockType() {
        return BlockType.RESET_TIMER;
    }

    @Override
    public void serialize() {
        File blockFile = new File(super.getMain().getDataFolder(), "blocks/timer/reset_timer/" + super.getUuid().toString() + ".yml");
    ...
    public void execute(CodeExecutor codeExecutor) {
        ...
        getMain().gameTimerManager.resetTimer(timerUUID);
